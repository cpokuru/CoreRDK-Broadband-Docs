    ...
    function renderDonutChart() {
      ...
      function draw(progress) {
        ...
        entries.forEach(([label, count], i) => {
          ...
          const barX = labelX + maxLabelW + 4;
          const barW = Math.max(0, countColX - labelX - maxLabelW - 12);
          const fillW = Math.round(barW * count / total);
          ...
          ctx.fillRect(barX, y + 3, barW, 3);
          ctx.fillStyle = PALETTE[i % PALETTE.length];
          ctx.fillRect(barX, y + 3, fillW, 3);
                ...
                <div id="main-content" style="display:none">
                  ...
                  <div id="charts-row">
                    <div class="chart-card">
                      ...
                      <canvas id="donut-canvas" width="560" height="280" style="width:100%;height:auto;max-height:280px"></canvas>
